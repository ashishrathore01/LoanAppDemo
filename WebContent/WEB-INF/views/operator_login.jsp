<div class="login-div" id="login-operator-div">
	<span class="login-heading" style="">Operator Login</span>
	<div class="login-sub-div">
		<form class="login-form" method="post" action="./operator-login.do">
			...
			<table>
				...
				<tr>
					<td>Password:</td>
					<td><input type="password" name="password" name="password"/></td>
				</tr>
				<%-- <tr>
					<td>Role:</td>
					<td><select name="role">
